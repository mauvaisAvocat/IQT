<footer class="container py-5">
    ...
    <script src="./Product example for Bootstrap_files/jquery-3.2.1.slim.min.js.descarga" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>
    <script>window.jQuery || document.write('<script src="../../assets/js/vendor/jquery-slim.min.js"><\/script>')</script>
    <script src="./Product example for Bootstrap_files/popper.min.js.descarga"></script>
    <script src="./Product example for Bootstrap_files/bootstrap.min.js.descarga"></script>
    <script src="./Product example for Bootstrap_files/holder.min.js.descarga"></script>
    <script>
